    ...
    <div class="container is-fluid">
        <form action="/upload" method="post" enctype="multipart/form-data">
            ...
            <div class="container has-text-centered">
                <button id="kaameranupp" class="button is-danger kaamera-button" onclick="take_picture()"><i class="fas fa-video kaamera-ikoon"></i>Käivita kaamera</button>
            </div>
            <div class="container has-text-centered">
            ...
            <div class="container has-text-centered">
                <input type="submit" class="button is-primary" value="Autentikeeri" />
            </div>
